...
pi = pigpio.pi()
my_echo1 = pi.callback(21, pigpio.RISING_EDGE,  _echo1)
my_echo0 = pi.callback(21, pigpio.FALLING_EDGE, _echo0)
...
while 1:
   print("right"+str(readDistance(5,21)))
   print("front"+str(readDistance(16,12)))
   print("left"+str(readDistance(25,20)))
   time.sleep(0.05)